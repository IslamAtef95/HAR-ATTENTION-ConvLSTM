...
if __name__ == '__main__':
    ...
    new_params = random_hyperparams((0.7, 0.8), (0.92, 0.94), (0.6, 0.7), num_vals=30)
    ...
    params = params + list(new_params)
    new_params = random_hyperparams((0.80,0.80),(0.93,0.93),(0.80,0.80),num_vals=1)
    params = params + list(new_params)
