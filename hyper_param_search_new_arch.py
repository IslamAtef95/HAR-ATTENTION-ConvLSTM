...
if __name__ == '__main__':
    ...
    new_params = random_hyperparams((0.8, 0.8), (0.97, 0.97), (0.8, 0.8), num_vals=1)
    params = params + list(new_params)
    ...
    new_params = random_hyperparams((0.74, 0.84), (0.92, 0.95), (0.74, 0.84), num_vals=30)
    params = params + list(new_params)
    #
    # new_params = random_hyperparams((0.74, 0.8), (0.94, 0.97), (0.1, 0.8), num_vals=20)
    # params = params + list(new_params)
