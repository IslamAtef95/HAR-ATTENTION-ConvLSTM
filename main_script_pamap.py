...
dir = '/coc/pcba1/vmurahari3/deepconvlstmattention/PAMAP2.mat'

use_cuda = torch.cuda.is_available()

# Hardcoded number of sensor channels employed in the OPPORTUNITY
...
def train_model(model,output_dir, num_epochs= 5, lr=1e-3, lr_decay = 0.97, momentum = 0.9, print_every = 80, evaluate_every=1, handle=None):
    import copy
...
def read_cmd_args():
    ...
    best_score, best_model = train_model(model,out_dir, lr_decay=lr_decay, num_epochs=26)
